...
import com.example.fit5046_lab4_group3_ass2.ui.screens.ROUTE_CONTACT_SUPPORT
import com.example.fit5046_lab4_group3_ass2.ui.screens.ROUTE_ABOUT_APP
import com.example.fit5046_lab4_group3_ass2.ui.screens.ROUTE_SDG_LEARN
import com.example.fit5046_lab4_group3_ass2.ui.screens.ContactSupportScreen
import com.example.fit5046_lab4_group3_ass2.ui.screens.AboutAppScreen
import com.example.fit5046_lab4_group3_ass2.ui.screens.LearnSdgScreen
...
private fun AppNav() {
    ...
    NavHost(
        ...
        composable(ROUTE_CONTACT_SUPPORT) { ContactSupportScreen(onBack = { nav.popBackStack() }) }
        composable(ROUTE_ABOUT_APP)     { AboutAppScreen(onBack = { nav.popBackStack() }) }
        composable(ROUTE_SDG_LEARN)     { LearnSdgScreen(onBack = { nav.popBackStack() }) }
        ...
        composable(ROUTE_PROFILE) {
            ProfileRoute(
                ...
                onContactSupport = { nav.navigate(ROUTE_CONTACT_SUPPORT) },
                onAboutApp = { nav.navigate(ROUTE_ABOUT_APP) },
                onLearnSdg = { nav.navigate(ROUTE_SDG_LEARN) },
                onTabSelected = ::onTab
            )
        }
